...
public class main extends javax.swing.JFrame {
    ...
    DefaultListModel lp = new DefaultListModel();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Personne.setNom(jTextField1.getText());
        Personne.setPrenom(jTextField2.getText());
        
        SimpleDateFormat sf = new SimpleDateFormat("dd/MM/yyyy");
        
        Date datenais;
        try {
            datenais = sf.parse(jTextField3.getText());
       ...
       // ListePersonne.clear();
        ...
        //Personne P1 = new Personne(jTextField1.getText(),jTextField2.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        lp = new DefaultListModel();
        jList1.setModel(lp);
        for(int i=0; i < ListePersonne.size(); i++){
            lp.addElement(ListePersonne.get(i));
